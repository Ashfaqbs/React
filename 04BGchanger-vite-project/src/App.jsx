...
function App() {
  ...
  return (
    <div className="w-full h-screen duration-200" style={{backgroundColor:color}}>
      ...
      <h2 style={{ justifyContent:"center",display:"flex",color:"black",fontWeight:"bolder"}}>Background Color Changer</h2>
      <section className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2" >
        
        <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-2xl text-white shadow-sm"style={{color:'black'}}> 
